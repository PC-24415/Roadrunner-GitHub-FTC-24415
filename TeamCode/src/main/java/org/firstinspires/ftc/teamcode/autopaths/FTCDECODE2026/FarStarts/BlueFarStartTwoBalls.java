...
@Autonomous(name = "BlueFarStartTwoBalls")
public class BlueFarStartTwoBalls extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        Action path = drive.actionBuilder(beginPose)
                ...
                .stopAndAdd(TriLift())
                .stopAndAdd(intakemotor.setpowerOn())
                .splineToLinearHeading(new Pose2d(8, -33, Math.toRadians(270)), 3 * Math.PI / 2)
                .lineToY(-55)
                .lineToY(-35)
                .splineTo(new Vector2d(50,-12), Math.toRadians(200- 180))
                .stopAndAdd(TriLift())
