...
@Autonomous(name = "RedFarStartsTwoBalls")
public class RedFarStartsTwoBalls extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        Action path = drive.actionBuilder(beginPose)
                ...
                .lineToY(62)
                .lineToY(56)
                .splineToLinearHeading( new Pose2d(50,12,Math.toRadians(157)), Math.toRadians(150))
                .stopAndAdd(TriLift())
                .stopAndAdd(intakemotor.setpowerOn())
                .splineTo(new Vector2d(7, 38), Math.toRadians(90))
                .lineToY(62)
                .lineToY(50)
                .splineToLinearHeading(new Pose2d(50,12, Math.toRadians(157)), Math.toRadians(335))
                .stopAndAdd(TriLift())
