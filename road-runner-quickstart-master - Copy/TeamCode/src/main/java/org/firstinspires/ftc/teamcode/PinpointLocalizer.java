...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3536.642538143837; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3995.7332772988234; // x position of the perpendicular encoder (in tick units)
    }
